...
const ProfileCard = async () => {
  ...
  return (
    <div className="p-4 bg-BlackCalido rounded-lg shadow-md text-sm flex flex-col gap-6 border border-BorderColor">
      ...
      <div className="h-20 flex flex-col gap-2 items-center text-WhiteCalido">
        ...
        <Link href={`/profile/${user.username}`}>
          <button className="bg-VioletCalido text-WhiteCalido text-xs p-2 rounded-md">
            Mi Perfil
          </button>
        </Link>
      </div>
